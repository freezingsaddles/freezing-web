...
Select "athlete_snapshot_20180101" as tablename, "BASE TABLE" as tabletype,   count(*) from athlete_snapshot_20180101 Union 
...
Select "dups" as tablename, "BASE TABLE" as tabletype,   count(*) from dups Union 
Select "forum_users" as tablename, "BASE TABLE" as tabletype,   count(*) from forum_users Union 
...
Select "refreshed_athletes" as tablename, "BASE TABLE" as tabletype,   count(*) from refreshed_athletes Union 
Select "registrants" as tablename, "BASE TABLE" as tabletype,   count(*) from registrants Union 
...
Select "ride_errors" as tablename, "BASE TABLE" as tabletype,   count(*) from ride_errors Union 
